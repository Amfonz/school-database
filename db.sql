...
CREATE TABLE DEPARTMENT_STAFF (
  ...
  ID INT NOT NULL FOREIGN KEY REFERENCES TEACHERS(ID),
...
CREATE TABLE STUDENTS (
  ...
  LOCKER_NUMBER INT FOREIGN KEY REFERENCES LOCKERS(LOCKER_NUMBER)
);

CREATE TABLE STAFF_PURCHASE (
  ORDER_REFERENCE INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
  ID INT FOREIGN KEY REFERENCES TEACHERS(ID),
  ITEM VARCHAR(50),
